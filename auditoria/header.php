...
<nav id="lateral" class="navbar-dark bg-dark align-content-center">
	...
	<ul class="navbar-nav">
		<li class="nav-item"><a class="nav-link" href="http://localhost/proyectobd2/auditoria/index.php"> <i class="fas fa-home"></i> Inicio</a></li>
		<li class="nav-item"><a class="nav-link" href="http://localhost/proyectobd2/auditoria/auditoria.php"><i class="fas fa-users"></i> Cheques</a></li>
