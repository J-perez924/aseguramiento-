...
<nav id="lateral" class="navbar-dark bg-dark align-content-center">
		...
		<ul class="navbar-nav">
		<li class="nav-item">
		   <a class="nav-link" href="http://localhost/proyectobd2/admin/index.php"> <i class="fas fa-home"></i> Inicio
		    </a>
		</li>
		<li class="nav-item"><a class="nav-link" href="http://localhost/proyectobd2/admin/usuarios.php"><i class="fas fa-users"></i> Usuarios</a></li>


		  <!-- Boton submenu tickets -->
		<button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#moduloscollapse">
    		<span class="fas fa-ticket-alt"></span> Gestion
  		</button>
 		  <!-- Sub-menu Gestion-->
  		<div class="collapse navbar-collapse" id="moduloscollapse">
    		<ul class="navbar-nav">
      			<li class="nav-item"> 
      				<a class="nav-link" href="http://localhost/proyectobd2/admin/modulos.php"> 
		...
		<button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#reportecollapse">
    		<span class="fas fa-file-excel"></span> Reportes
  		</button>
 		  <!-- Sub-menu Reportes-->
  		<div class="collapse navbar-collapse" id="reportecollapse">
    		<ul class="navbar-nav">
      			...
      			<li class="nav-item"> <a class="nav-link" href="#"><i class="fas fa-check-circle"></i> cheques</a> </li>
